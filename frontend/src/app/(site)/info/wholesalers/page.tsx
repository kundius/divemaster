          ...
          <div className="grid gap-12 text-center md:grid-cols-2">
            <div>
              <p className="mb-4 text-xl text-neutral-500">
                "Хочу отметить хорошее качество товара и в меру мягкий силикон масок и трубок.
                ...
                модель-предшественник бора-бора. В целом соотношение "цена/качество" очень хорошее,
                всем рекомендую!"
              </p>
              <p className="italic">
                Магазины подводного снаряжения "Акула", г. Анапа - Юрий Трунев
              </p>
            </div>

            <div>
              <p className="mb-4 text-xl text-neutral-500">
                "Неоднократно приобретали продукцию Divemaster для реализации, она пользуется
                большим спросом. Сочетание "цена/качество" на 100%. "
              </p>
              <p className="italic">
                Магазин подводного снаряжения "Китобой", г. Саратов - Наталья Коротаева
              </p>
            </div>

            <div>
              <p className="mb-4 text-xl text-neutral-500">
                "Продукцию Divemaster приобретаем с момента появления бренда, всем довольны. Продажи
                товаров отличные, покупателям всё нравится, никаких претензий не поступало."
              </p>
              <p className="italic">
                Магазин "Всё для подводной охоты", г. Новороссийск - Михаил Кузнецов
              </p>
            </div>

            <div>
              <p className="mb-4 text-xl text-neutral-500">
                "О продукции можем сказать только самое хорошее. "Цена/качество" - просто отлично.
