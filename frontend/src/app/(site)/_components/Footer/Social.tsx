  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.list}>
        <Link
          href="https://ok.ru/group/49481371549835"
          className={cn(styles.item, styles.itemOk)}
          target="_blank"
        >
        ...
        <Link
          href="https://vk.com/clubpodvoh"
          className={cn(styles.item, styles.itemVk)}
          target="_blank"
        >
          <SpriteIcon name="social-vk" />
        </Link>
        <Link
          href="https://rutube.ru/channel/46176466/"
          className={cn(styles.item, styles.itemRutube)}
          target="_blank"
        >
