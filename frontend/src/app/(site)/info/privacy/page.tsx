    ...
    <SectionPage>
      ...
      <div className="mx-auto prose lg:prose-xl">
        <p>
          ...
          – Интернет-магазин) расположенный на доменном имени divermaster.ru (а также его
          субдоменах), может получить о Пользователе во время использования сайта divermaster.ru (а
        ...
        <p>
          ...
          в сети Интернет по уникальному адресу (URL): divermaster.ru, а также его субдоменах.
        </p>
        ...
        <p>
          ...
          http://divermaster.ru/privacy-policy
        </p>
