...
export class Migration20240806000003 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table `brand` (`id` int unsigned not null auto_increment primary key, `title` varchar(255) not null) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `category` (`id` int unsigned not null auto_increment primary key, `title` varchar(255) not null, `long_title` varchar(255) null, `alias` varchar(255) not null, `description` text null, `active` tinyint(1) not null default true, `image_id` int unsigned null, `parent_id` int unsigned null) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `product` (`id` int unsigned not null auto_increment primary key, `title` varchar(255) not null, `long_title` varchar(255) null, `alias` varchar(255) not null, `sku` varchar(255) null, `price_decrease` int null, `description` text null, `specifications` text null, `exploitation` text null, `active` tinyint(1) not null default true, `in_stock` tinyint(1) not null default true, `recent` tinyint(1) not null default false, `favorite` tinyint(1) not null default false, `brand_id` int unsigned null) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `offer` (`id` int unsigned not null auto_increment primary key, `title` varchar(255) null, `price` int not null, `rank` int not null default 0, `product_id` int unsigned not null) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `cart_product` (`uuid` varchar(36) not null, `cart_uuid` varchar(36) not null, `product_id` int unsigned not null, `amount` int unsigned not null default 1, `created_at` datetime not null, `updated_at` datetime not null, primary key (`uuid`, `cart_uuid`)) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `cart_product_option_values` (`cart_product_uuid` varchar(36) not null, `cart_product_cart_uuid` varchar(36) not null, `option_value_id` int unsigned not null, primary key (`cart_product_uuid`, `cart_product_cart_uuid`, `option_value_id`)) default character set utf8mb4 engine = InnoDB;');
